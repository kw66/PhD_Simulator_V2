    ...
    <section class="lobby-profile-info">
      <div class="lobby-profile-info-head">
        ...
        ${viewModel.unlockState.owned
          ? `<button class="lobby-start-button" type="button" data-action="start-game" data-role-id="${viewModel.role.id}"><span class="lobby-start-button-mark" aria-hidden="true"></span><span class="lobby-start-button-label">开始游戏</span><span class="lobby-start-button-arrow" aria-hidden="true">→</span></button>`
          : `<button class="lobby-start-button is-disabled" type="button" disabled><span class="lobby-start-button-mark" aria-hidden="true"></span><span class="lobby-start-button-label">未解锁</span><span class="lobby-start-button-arrow" aria-hidden="true">—</span></button>`}
      </div>
