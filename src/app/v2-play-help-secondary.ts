...
const SHOP_PAGES: Record<ShopTabId, readonly PlayHelpPage[]> = {
  ...
  coffee: [{
    title: "咖啡与续费",
    summary: "",
    body: "<p>冰美式可直接购买，<b>SAN+2</b>；购入咖啡机后提升为<b>SAN+3</b>，并可开启月初自动续费。</p><p>SAN已满时，自动续费当月跳过。金币不足且没有可用于续费的礼物券时，当月暂停续费。</p><p>礼物券优先用于手动购买；没有装备、新购或升级可买时，可用于自动续费。</p>",
  }],
  gear: [{
    title: "装备与季节",
    summary: "",
    body: "<p>显卡和自行车可逐档升级，提升效果。</p><p><b>夏季（公历6–8月）：</b>主动操作SAN消耗+1，遮阳伞可免除。</p><p><b>冬季（公历12–2月）：</b>每月SAN-1，羽绒服可免除。</p>",
  }],
};
