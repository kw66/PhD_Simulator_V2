...
const ENDINGS: Record<Exclude<EndingId, null>, EndingPresentation> = {
  master: {
    ...
    story: ["离校手续终于办完，你把工位收拾干净，带走电脑和那本写满批注的笔记。曾经反复修改的论文、跑不通的实验，现在都成了这段求学生活的一部分。", "你完成了硕士阶段的科研要求。下一站的生活还没有标准答案，但这一次，你可以带着自己的成果出发。"],
    closing: "把学位留作纪念，把好奇心带去下一站",
  },
  phd: {
    title: "博士毕业", icon: "🎓", label: "学业完成", tone: "success",
    story: ["离开实验室前，你又看了一眼那个熟悉的工位。目录里存着一版又一版稿件，实验记录中既有好结果，也有花了很久才承认走不通的路。", "你完成了博士阶段的科研要求。从最初等别人告诉你该做什么，到能够提出问题、寻找证据，这段漫长的训练终于有了一个句点。"],
    closing: "学位有终点，探索没有",
  },
  burnout: {
    ...
    closing: "研究可以重来，休息也值得认真安排",
  },
  poor: {
    title: "穷困潦倒", icon: "💸", label: "提前离校", tone: "failure",
    story: ["你又核对了一遍余额。补助还没等到，眼前的开销却已经付不出了；论文里的问题尚可慢慢想，生活里的账单不会等实验结束。", "你不得不中断学业，收拾东西离开实验室。手头还没做完的研究，只能先停在这里。"],
    closing: "下一次，也给日常开销留一点余地",
  },
  expelled: {
  ...
  isolated: {
    ...
    closing: "埋头做研究时，也别忘了身边的人",
  },
  delay: {
    title: "延毕", icon: "⏰", label: "未能按期毕业", tone: "pause",
    story: ["毕业季到了，身边有人忙着交接工位，有人开始准备下一站。你翻开自己的成果清单，离毕业要求还差一点。", "这一轮培养期已经结束，你没能按期毕业。做过的尝试并非毫无意义，只是它们还没能在期限内汇成足够的成果。"],
    closing: "这一轮停在这里，下一次从新的安排开始",
  },
  quit: {
