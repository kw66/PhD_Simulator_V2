...
function createBeforeGradSchoolResultEvent(
  ...
  return createFixedEvent({
    ...
    description: [
      ...
      "大四开学后，学院公布推免资格名单，你在里面找到了自己的名字。九月，推免系统正式开放，你填报了之前拿到预录取的学校，并在系统里接受待录取。随后，老师把你拉进了实验室群。",
...
export function createBeforeGradSchoolAct1Event(
  ...
  return createFixedEvent({
    ...
    description: [
      ...
      "暑假里，你参加了夏令营，结束后又继续报预推免。为了准备面试，你重新梳理做过的项目和技术细节，也提前想过老师可能会问什么。忙了几个月，最后很幸运，你拿到了心仪学校的预录取，保上了最想去的学校。正式手续还没开始，你先去联系导师。",
    ].join("\n\n"),
