...
const AI_MODEL_TIMELINE: readonly AiModelOffer[] = [
  ...
  { id: "gpt-4o", slot: "gpt", name: "GPT-4o", provider: "OpenAI", releaseYear: 2024, releaseMonth: 9, price: 2, description: "多模态能力更完整，日常科研更顺手。", researchEffects: { idea: { bonus: 4 }, experiment: { bonus: 4 }, writing: { bonus: 4 } } },
  { id: "gpt-5", slot: "gpt", name: "GPT-5", provider: "OpenAI", releaseYear: 2025, releaseMonth: 9, price: 3, description: "推理能力明显提升，适合处理复杂研究任务。", researchEffects: { idea: { bonus: 5 }, experiment: { bonus: 5 }, writing: { bonus: 5 } } },
  { id: "gpt-5.6-sol", slot: "gpt", name: "GPT-5.6-sol", provider: "OpenAI", releaseYear: 2026, releaseMonth: 9, price: 3, description: "前沿通用模型，研究辅助更稳定。", researchEffects: { idea: { bonus: 6 }, experiment: { bonus: 6 }, writing: { bonus: 6 } } },
  { id: "gpt-6", slot: "gpt", name: "GPT-6", provider: "OpenAI", releaseYear: 2027, releaseMonth: 9, price: 4, description: "复杂推理和长任务协作进一步增强。", researchEffects: { idea: { bonus: 7 }, experiment: { bonus: 7 }, writing: { bonus: 7 } } },
  { id: "gpt-7", slot: "gpt", name: "GPT-7", provider: "OpenAI", releaseYear: 2028, releaseMonth: 9, price: 4, description: "成熟的高阶通用模型，科研三项都更有把握。", researchEffects: { idea: { bonus: 8 }, experiment: { bonus: 8 }, writing: { bonus: 8 } } },

  { id: "claude-2", slot: "claude", name: "Claude 2", provider: "Anthropic", releaseYear: 2023, releaseMonth: 9, price: 2, description: "长文本理解较好，先从想法梳理开始帮忙。", researchEffects: { idea: { bonus: 2 } } },
  { id: "claude-3.5-sonnet", slot: "claude", name: "Claude 3.5 Sonnet", provider: "Anthropic", releaseYear: 2024, releaseMonth: 9, price: 2, description: "分析和代码能力均衡，适合推演实验方案。", researchEffects: { idea: { bonus: 2 }, experiment: { bonus: 2 } } },
  { id: "claude-opus-4.6", slot: "claude", name: "Claude Opus 4.6", provider: "Anthropic", releaseYear: 2025, releaseMonth: 9, price: 4, description: "高阶研究协作，三项科研都能提供实质帮助。", researchEffects: { idea: { bonus: 2 }, experiment: { bonus: 2 }, writing: { bonus: 2 } } },
  { id: "claude-fable-5", slot: "claude", name: "Claude Fable 5", provider: "Anthropic", releaseYear: 2026, releaseMonth: 9, price: 4, description: "更擅长把零散思路整理成可执行方案。", researchEffects: { idea: { bonus: 4 }, experiment: { bonus: 2 }, writing: { bonus: 2 } } },
  { id: "claude-fable-6", slot: "claude", name: "Claude Fable 6", provider: "Anthropic", releaseYear: 2027, releaseMonth: 9, price: 6, description: "复杂实验和论文结构都能得到更细致的打磨。", researchEffects: { idea: { bonus: 4 }, experiment: { bonus: 4 }, writing: { bonus: 2 } } },
  { id: "claude-fable-7", slot: "claude", name: "Claude Fable 7", provider: "Anthropic", releaseYear: 2028, releaseMonth: 9, price: 6, description: "顶级长文本协作，科研三项都能充分润色。", researchEffects: { idea: { bonus: 4 }, experiment: { bonus: 4 }, writing: { bonus: 4 } } },

  { id: "gemini-1.5", slot: "gemini", name: "Gemini 1.5", provider: "Google", releaseYear: 2023, releaseMonth: 9, price: 1, description: "长上下文模型，科研操作固定少耗 1 SAN。", researchEffects: { idea: { sanDelta: -1 }, experiment: { sanDelta: -1 }, writing: { sanDelta: -1 } } },
  { id: "gemini-2.0", slot: "gemini", name: "Gemini 2.0", provider: "Google", releaseYear: 2024, releaseMonth: 9, price: 1, description: "多模态协作更稳定，科研操作固定少耗 1 SAN。", researchEffects: { idea: { sanDelta: -1 }, experiment: { sanDelta: -1 }, writing: { sanDelta: -1 } } },
  ...
  { id: "deepseek-v2", slot: "deepseek", name: "DeepSeek-V2", provider: "DeepSeek", releaseYear: 2023, releaseMonth: 9, price: 1, description: "开源模型，科研三项各多执行 1 次。", researchEffects: { idea: { extraActions: 1 }, experiment: { extraActions: 1 }, writing: { extraActions: 1 } } },
  { id: "deepseek-v3.2", slot: "deepseek", name: "DeepSeek-V3.2", provider: "DeepSeek", releaseYear: 2024, releaseMonth: 9, price: 1, description: "在 V2 基础上提升推理稳定性，科研三项各多执行 1 次。", researchEffects: { idea: { extraActions: 1 }, experiment: { extraActions: 1 }, writing: { extraActions: 1 } } },
  { id: "deepseek-r1", slot: "deepseek", name: "DeepSeek-R1", provider: "DeepSeek", releaseYear: 2025, releaseMonth: 9, price: 1, description: "推理模型，科研三项各多执行 2 次。", researchEffects: { idea: { extraActions: 2 }, experiment: { extraActions: 2 }, writing: { extraActions: 2 } } },
  { id: "deepseek-v4", slot: "deepseek", name: "DeepSeek-V4", provider: "DeepSeek", releaseYear: 2026, releaseMonth: 9, price: 2, description: "更适合高频实验迭代，科研三项各多执行 2 次。", researchEffects: { idea: { extraActions: 2 }, experiment: { extraActions: 2 }, writing: { extraActions: 2 } } },
  { id: "deepseek-v5", slot: "deepseek", name: "DeepSeek-V5", provider: "DeepSeek", releaseYear: 2027, releaseMonth: 9, price: 2, description: "低价高频辅助，科研三项各多执行 3 次。", researchEffects: { idea: { extraActions: 3 }, experiment: { extraActions: 3 }, writing: { extraActions: 3 } } },
  { id: "deepseek-v6", slot: "deepseek", name: "DeepSeek-V6", provider: "DeepSeek", releaseYear: 2028, releaseMonth: 9, price: 2, description: "低价高频辅助，科研三项各多执行 3 次。", researchEffects: { idea: { extraActions: 3 }, experiment: { extraActions: 3 }, writing: { extraActions: 3 } } },
  ...
  { id: "kimi-k1.5", slot: "kimi", name: "Kimi k1.5", provider: "月之暗面", releaseYear: 2024, releaseMonth: 9, price: 1, description: "一次手动看论文可完成两次阅读。", researchEffects: {}, readingEffect: { sanDelta: -1, manualExtraReads: 1 } },
  { id: "kimi-k2", slot: "kimi", name: "Kimi K2", provider: "月之暗面", releaseYear: 2025, releaseMonth: 9, price: 2, description: "每月自动看论文 1 次。", researchEffects: {}, readingEffect: { sanDelta: -1, automaticReads: 1 } },
  { id: "kimi-k3", slot: "kimi", name: "Kimi K3", provider: "月之暗面", releaseYear: 2026, releaseMonth: 9, price: 2, description: "每月自动看论文 1 次。", researchEffects: {}, readingEffect: { sanDelta: -1, automaticReads: 1 } },
  { id: "kimi-k4", slot: "kimi", name: "Kimi K4", provider: "月之暗面", releaseYear: 2027, releaseMonth: 9, price: 3, description: "每月自动看论文 2 次。", researchEffects: {}, readingEffect: { sanDelta: -1, automaticReads: 2 } },
  { id: "kimi-k5", slot: "kimi", name: "Kimi K5", provider: "月之暗面", releaseYear: 2028, releaseMonth: 9, price: 3, description: "每月自动看论文 2 次。", researchEffects: {}, readingEffect: { sanDelta: -1, automaticReads: 2 } },
];
