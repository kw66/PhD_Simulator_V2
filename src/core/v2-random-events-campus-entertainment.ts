...
export function createEntertainmentCampusRandomEvent(state: GameState, getRoll: RandomRollProvider): PendingEvent {
  ...
  return createThreeStageRandomEvent(event, {
    ...
    decisionTitle: "选择游戏",
    decisionDescription: [
      "“泰拉瑞亚，房间开好了！”耳机里有人催你，接着保证只玩“一小会儿”⏱️。你看了眼时间，已经想起上次说这句话以后，大家又挖了多深的矿。",
      "桌面上还躺着没通关的魔塔，卡住的那层一直让你惦记。旁边的研究生模拟器倒让你笑了一下：白天刚从实验室回来，晚上还要再读一个研？",
      "手机又弹出一条王者代练单，有报酬，也有明确的段位要求。你把耳机戴正，今晚是陪朋友闹一阵、自己玩，还是再挣点零花钱，得先回个话了。",
    ].join("\n\n"),
    results: {
